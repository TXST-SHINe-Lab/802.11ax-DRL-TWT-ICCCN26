...
#
# Every parameter below can be overridden from the environment, so no edit is needed for a one-off run.
#
# Usage:
#     ./1-collect-data.sh
#     NUM_SPAWNS=50 STEPS_PER_SPAWN=38 ./1-collect-data.sh    # short run
